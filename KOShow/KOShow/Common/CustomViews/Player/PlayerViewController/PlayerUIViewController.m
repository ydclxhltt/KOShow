...
- (void)addToolBarView
{
    _roomToolBarView = [[RoomToolBarView alloc] initWithFrame:CGRectMake(0, self.downSideView.frame.size.height - TOOL_BAR_HEIGHT, self.view.frame.size.width, TOOL_BAR_HEIGHT)];
